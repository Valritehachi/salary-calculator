      ...
      <main className="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-100 pt-6 pb-8">
          <div className="max-w-3xl mx-auto space-y-2">
            {[
              { q: 'What drives the biggest cost differences between cities?', a: 'Housing. It accounts for 30–40% of most budgets and varies more than any other category — rents in SF can be 3× those in Houston.' },
              { q: 'Is a higher salary in an expensive city actually worth it?', a: "Not always. A $120k salary in San Francisco can leave you with less purchasing power than $80k in Austin once rent and taxes are factored in." },
            ].map(({ q, a }) => (
